...
import com.bbdservice.sichuan.dao.ProvinceSearchTrendRepository;
...
public class ProvinceSearchTrendServiceImpl implements ProvinceSearchTrendService{
    ...
    public String url;
    @Autowired
    public ProvinceSearchTrendRepository provinceSearchTrendRepository;
    ...
    public List<ProvinceSearchTrend> getTrendData(Integer year) {
     ...
     //      this.provinceSearchTrendRepository.deleteByYearAndDeletedFalse(year);
           this.provinceSearchTrendRepository.deleteBy(year);
        }
        ...
        if (result != null && result.size() > 0) {
            ...
            this.provinceSearchTrendRepository.save(provinceSearchTrends);
